...
def creador_de_modelo(cargar = None):
    global datos, colx_vars, coly_var, root, modelo_g, canvas
    ...
    if cargar == None:
        ...
        if columnas_x_seleccionadas and columna_y_seleccionada:
            ...
            try:
                ...
                # Configurar el evento para ajustar el área de desplazamiento cuando cambie el tamaño del lienzo
                main_frame.grid_rowconfigure(9, weight=1)  # Ajuste de fila para que el label se expanda verticalmente
...
def grafica_modelo():
    ...
    if datos is not None:
        ...
        if columnas_x_seleccionadas and columna_y_seleccionada:
            ...
            if len(columnas_x_seleccionadas) == 2:
                ...
                # Plot de la regresión lineal en 3D
                ax.plot(x_test[columnas_x_seleccionadas[0]], x_test[columnas_x_seleccionadas[1]], y_pred, color='blue', linewidth=3)
