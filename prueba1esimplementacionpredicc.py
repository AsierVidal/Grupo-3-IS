# -*- coding: utf-8 -*-
"""
Created on Wed Dec 13 15:15:21 2023
...
def calcular_prediccion(modelo, datos_nuevos):
...
def creador_de_modelo():
    ...
    if columnas_x_seleccionadas and columna_y_seleccionada:
        ...
        calcular_prediccion_boton = tk.Button(root, text='Calcular Predicción', command=lambda: calcular_prediccion(modelo_g))
        calcular_prediccion_boton.place(x=620, y=420)
...
def grafica_modelo():
    ...
    if datos is not None:
        ...
        if columnas_x_seleccionadas and columna_y_seleccionada:
            ...
            calcular_prediccion_boton = tk.Button(root, text='Calcular Predicción', command=lambda: calcular_prediccion(modelo))
            calcular_prediccion_boton.place(x=620, y=460)
