...
def creador_de_modelo():
    ...
    if columnas_x_seleccionadas and columna_y_seleccionada:
        ...
        # Generar y mostrar la interfaz gráfica
        mostrar_interfaz_grafica()
        grafica_modelo()

        # Generar y mostrar la ecuación de la regresión
        ecuacion_texto = escribir_ecuacion2((modelo_g.coly, modelo_g.cols_x_dict, modelo_g.const, []))
